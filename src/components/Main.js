    ...
    <>
      <section className="profile">
        <div className="profile__info">
          <a className="profile__overlay" href="#" onClick={props.onEditAvatar}>
        ...
        <button className="profile__button-add" type="button" aria-label="кнопка добавить" onClick={props.onAddPlace}></button>
      </section>
